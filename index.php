...
class Carta
{
    ...
    function __construct(int $numero, string $nombre, string $img, string  $color, string $mana){
        $this->numero = $numero;
        $this->nombre = $nombre;
        $this->img = $img;
        $this->color = $color;
...
$cartas = array();
$cartas[0] = new Carta(0,'Bola de fuego', 'fireball.jpg','red','mana_rojo.jfif');
$cartas[0]->setTexto("Esta Bola de Fuego destruye a todos los oponentes en el campo de batalla");
$cartas[1] = new Carta(1,'Dragon Shivano', 'dragon.jpg','green','mana_verde.png');
$cartas[1]->setTexto("El dragón Shivano destruyó la economía de Wariburgo al robar todas las monedas de oro");
$cartas[2] = new Carta(1,'Ángel de Esperanza', 'angel.jpg','white','mana-blanco.png');
...
<body>
    <?php if($c != null):?>
        <div class="centrado carta_<?php echo $c->getColor()?>">
            <div class="centrado caja">
                <h1><?php echo $c->getNombre(); ?></h1>
                <img class="centrado caja" src="<?php echo $c->getMana()?>"/>
